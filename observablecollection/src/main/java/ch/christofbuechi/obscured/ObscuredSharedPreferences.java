package ch.christofbuechi.obscured;
...
/**
 * Christof Buechi:
 * Forked and modified for my personal use
 *
...
public class ObscuredSharedPreferences implements SharedPreferences {
     ...
     * @param key
     */
    public static void initialKey(String key) {
     ...
     * @return
     */
    public synchronized static ObscuredSharedPreferences getPrefs(Context context, String appName, int contextMode) {
        if (prefs == null) {
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        @Override
        public void apply() {
            //to maintain compatibility with android level 8
            delegate.commit();
        }
